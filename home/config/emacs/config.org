  ...
  (use-package lsp-ui
    ...
    :config
      (setq lsp-ui-sideline-enable t           ; Show sideline information (errors, warnings, etc.)
        lsp-ui-sideline-show-symbol t     ; Show symbol information in sideline
        ...
        lsp-ui-doc-include-signature t    ; Include function signatures in documentation
        lsp-ui-doc-position 'bottom       ; Show documentation at the bottom
        lsp-ui-doc-delay 0.5               ; Delay before showing documentation
        lsp-ui-peek-enable t              ; Enable peek definition UI
        lsp-ui-peek-always-show t         ; Always show peek UI even if there's only one candidate
        lsp-ui-peek-fontify 'always       ; Fontify code in peek UI
...
#+begin_src emacs-lisp
  ...
  (setq c-basic-offset 4
        c-indent-level 4
        c-default-style (cons '(c-mode . "k&r") c-default-style)
        c-default-style "bsd"))
